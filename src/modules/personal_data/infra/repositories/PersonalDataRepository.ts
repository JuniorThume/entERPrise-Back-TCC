...
class PersonalDataRepository implements IPersonalDataRepository {
  ...
  public async findById(id: number): Promise<IPersonalData | null> {
    return await this.ormPersonalDataRepository.findOneBy({ id });
  }

  public async findByName(name: string): Promise<IPersonalData | null> {
    return await this.ormPersonalDataRepository.findOneBy({ name });
  }

  public async findByEmail(email: string): Promise<IPersonalData | null> {
    return await this.ormPersonalDataRepository.findOneBy({ email });
  }

  public async findByCPF(cpf: string): Promise<IPersonalData | null> {
    return await this.ormPersonalDataRepository.findOneBy({ cpf });
  }

  public async create(personal_data: IPersonalData): Promise<IPersonalData> {
    return await this.ormPersonalDataRepository.save(personal_data);
  }

  public async update(personal_data: IPersonalData): Promise<IPersonalData> {
    return await this.ormPersonalDataRepository.save(personal_data);
  }

  public async delete(personal_data: IPersonalData): Promise<void> {
    await this.ormPersonalDataRepository.remove(personal_data);
  }
}
